...
- **Programming & Tools:** Python, PyTorch, Hugging Face Transformers, Fairseq, SLURM (distributed training on multiple GPUs and nodes), Git, Linux, Docker, TypeScript
...
Developed **BRAG (Biomedical RAkinG)** is a cross-platform tool that aggregates bibliographic data from sources like PubMed and Google Scholar to summarise researchers’ scientific output, including publications, citations, h-index, and optional graphical representations. This was a school project at Centrale Nantes.
...
- 🌐 [Personal website](https://lydianishimwe.info)  
- 💼 [LinkedIn](https://www.linkedin.com/in/lydia-nishimwe)  
- 🐦 [X/Twitter](https://twitter.com/LydiaNishimwe)  
